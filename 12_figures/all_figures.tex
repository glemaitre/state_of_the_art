...
\begin{figure*}
  ...
  \subfigure[]{
    ...
    \begin{tikzpicture}[scale=.5,every node/.style={scale=0.5}]
      ...
      \def\labels{
        {\color{semiAuto}\cite{Ampeliotis2008}},
        {\color{semiAuto}\cite{Antic2013}},
        {\color{semiAuto}\cite{Chan2003}},
        {\color{semiAuto}\cite{Giannini2013}},
        {\color{semiAuto}\cite{Langer2009}},
        {\color{semiAuto}\cite{Lopes2011}},
        {\color{semiAuto}\cite{Lv2009}},
        {\color{semiAuto}\cite{Niaf2011}},
        {\color{semiAuto}\cite{Niaf2012}},
        {\color{semiAuto}\cite{Tiwari2009a}},
        {\color{semiAuto}\cite{Tiwari2010}},
        {\color{semiAuto}\cite{Tiwari2012}},
        {\color{semiAuto}\cite{Tiwari2013}},
        {\color{semiAuto}\cite{Vos2008}},
        {\color{semiAuto}\cite{Vos2010}},
        {\color{semiAuto}\cite{Mazzetti2011}},
        {\color{semiAuto}\cite{Puech2009}},
        {\color{semiAuto}\cite{Vos2008a}}
      }
  ...
  \subfigure[]{
    ...
    \begin{tikzpicture}[scale=.5,every node/.style={scale=0.5}]
      ...
      \def\labels{
        {\color{semiAuto}\cite{Litjens2014}},
        {\color{semiAuto}\cite{Liu2013}},
        {\color{semiAuto}\cite{Peng2013}},
        {\color{semiAuto}\cite{Viswanath2009}},
        {\color{semiAuto}\cite{Viswanath2011}},
        {\color{semiAuto}\cite{Viswanath2012}}
      }
...
\begin{figure*}%
  ...
  \subfigure[]{
    ...
    \begin{tikzpicture}[scale=.5,every node/.style={scale=0.5}]
      ...
      \def\labels{
        {\color{semiAuto}\cite{Artan2009}},
        {\color{semiAuto}\cite{Artan2010}},
        {\color{semiAuto}\cite{Giannini2013}},
        {\color{semiAuto}\cite{Liu2009}},
        {\color{semiAuto}\cite{Lopes2011}},
        {\color{semiAuto}\cite{Ozer2009}},
        {\color{semiAuto}\cite{Ozer2010}},
        {\color{semiAuto}\cite{Tiwari2009a}},
        {\color{semiAuto}\cite{Viswanath2008}},
        {\color{semiAuto}\cite{Mazzetti2011}},
        {\color{semiAuto}\cite{Puech2009}},
        {\color{semiAuto}\cite{Tiwari2008}}
      }
  ...
  \subfigure[]{
    ...
    \begin{tikzpicture}[scale=.5,every node/.style={scale=0.5}]
      ...
      \def\labels{
        {\color{semiAuto}\cite{Peng2013}},
        {\color{semiAuto}\cite{Viswanath2008a}},
        {\color{semiAuto}\cite{Matulewicz2013}},
        {\color{semiAuto}\cite{Parfait2012}},
        {\color{semiAuto}\cite{Sung2011}}
      }
  ...
  \hspace*{\fill}
  \caption{Comparison of the results in terms of sensitivity \subref{fig:sens15}, \subref{fig:sens30} and specificity \subref{fig:spec15}, \subref{fig:spec30} for 1.5 and 3.0 Tesla \ac{mri} scanners. The {\color{blue}blue} value represents the metric and are graphically reported in the blue curve in the center of the figure. The {\color{red}red} value and areas correspond to the number of patients in the dataset. The numbers between brackets in {\color{semiAuto}green} correspond to the reference as reported in \acs{tab}~\ref{tab:sumpap}.}
  \label{fig:sensspec}
\end{figure*}
\restoregeometry
