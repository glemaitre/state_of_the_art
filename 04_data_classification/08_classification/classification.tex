...
Finally, Dice's coefficient is sometimes computed which corresponds to the similarity of a lesion between the ground-truth and the output of the classifier. This coefficient consists of the ratio of twice the number of pixels in common to the sum of the pixels of the lesions in the ground-truth and the output of the classifier.