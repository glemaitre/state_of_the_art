...
\centering
	\hspace*{\fill}
	\subfigure[]{\label{subfig:histoalgn} \includegraphics[width=0.2\textwidth]{03_image_processing/05_registration/figures/histogram/jointhistoalg.eps}} \hfill
	\subfigure[]{\label{subfig:histomisalgn} \includegraphics[width=0.2\textwidth]{03_image_processing/05_registration/figures/histogram/jointhistomisal.eps}}
	\hspace*{\fill}
