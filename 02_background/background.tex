...
\centering
	...
	\subfigure[\ac{adc} map computer after acquisition of \ac{dw}-\ac{mri} images with a 1.5 Tesla \ac{mri} scanner. The cancer corresponds to the low \ac{si} region highlighted in red.]{\label{subfig:adc}\includegraphics[width=0.45\linewidth]{02_background/figures/dwi/adc_cancer.eps}}
	\hspace*{\fill}
...
\begin{figure*}
	\centering
	\hspace*{\fill}
	\subfigure[]{\label{subfig:mrsihea}\includegraphics[width=0.45\linewidth]{02_background/figures/mrsi/mrsi_healthy.eps}} \hfill
	\subfigure[]{\label{subfig:mrsican}\includegraphics[width=0.45\linewidth]{02_background/figures/mrsi/mrsi_cancer.eps}}
	\hspace*{\fill}
